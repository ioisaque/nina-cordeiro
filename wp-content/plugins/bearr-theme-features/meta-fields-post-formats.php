...
function bearr_cpt_meta_fields( $meta_boxes ) {
    ...
    /*Post Format: Quote*/
    $meta_boxes[] = array(
        'title'      => __( 'Post Format: Quote - Options', 'bearr' ),
	...
	/*Post Format: Link*/
    $meta_boxes[] = array(
        'title'      => __( 'Post Format: Link - Options', 'bearr' ),
        'post_types' => array( 'post'),
        'context' => 'normal',
		'show' => array(
			'relation' => 'OR',
    ...
    /*Post Format: Vídeos*/
    $meta_boxes[] = array(
        'title'      => __( 'Post Format: Video – Options', 'bearr' ),
        'post_types' => array( 'post'),
        'context' => 'normal',
		'show' => array(
			'relation' => 'OR',
